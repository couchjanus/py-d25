...
# класс Payroll, который будет обрабатывает платежную ведомость:
...
# используя метод .calculate_payroll(), для каждого объекта сотрудника.
...
# торговые партнеры, которым выплачивается фиксированная зарплата 
# плюс комиссия, основанная на их продажах 
